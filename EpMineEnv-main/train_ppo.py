...
def main():
    ...
    use_amp = True
    resume = True
    resume_path = "./checkpoints/nav_policy4/ppo_model_1000000_steps.zip"
    ...
    if resume:
        ...
        model = CustomPPO.load(resume_path, env=env)
    else:
        model = CustomPPO(
    ...
    model.learn(total_timesteps=1e6, callback=[checkpoint_callback], reset_num_timesteps=False)
